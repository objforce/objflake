...
// While Objforce IDs use A-Z, a-z, and 0-9 we use this slice to find a
// value from 0-31.
...
var ErrValueTooLarge = errors.New("value is larger than 62^10")
...
func New(id string) (*ObjforceID, error) {
	var err error
...
const (
	...
	maxID      = 839299365868340224 // == 62 ^ 10
	base       = 62
)
